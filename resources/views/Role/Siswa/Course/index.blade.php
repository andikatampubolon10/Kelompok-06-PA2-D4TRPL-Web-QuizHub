...
@section('content')
  ...
  @forelse ($courses as $course)
    <a href="{{ route('Siswa.Course.tipeujian', ['id_kursus' => $course->id_kursus]) }}"
      ...
      <div class="h-24 rounded-md mb-3 overflow-hidden">
        <img
          src="{{ $course->foto_url ?? 'https://placehold.co/600x400?text=Kursus' }}"
  ...
  @empty
    <div class="col-span-1 sm:col-span-2 md:col-span-3 rounded-lg border border-dashed p-6 text-center text-muted-foreground">
