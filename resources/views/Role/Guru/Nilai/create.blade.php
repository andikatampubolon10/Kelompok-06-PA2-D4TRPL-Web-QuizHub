...
@section('content')
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
        <div class="flex items-start space-x-3">
            ...
            <div>
                <h4 class="text-sm font-semibold text-blue-800 mb-1">Tips Penambahan Nilai Persentase</h4>
                <ul class="text-xs text-blue-700 space-y-1">
                    <li>• Masukkan Persentase Kuis</li>
                    <li>• Masukkan Persentase UTS</li>
                    <li>• Masukkan Persentase UAS</li>
    ...
    <div class="form-container mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <form action="{{ route('Guru.Persentase.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-6">
                <label for="persentase_kuis"
                    ...
                    Kuis</label>
                <input type="number" id="persentase_kuis" name="persentase_kuis" placeholder="20" required
            ...
            <div class="mb-6">
                <label for="persentase_UTS"
                    class="text-sm font-medium text-gray-700 flex-shrink-0 w-full sm:w-auto">Persentase
                    UTS</label>
                <input type="number" id="persentase_UTS" name="persentase_UTS" placeholder="40" required
                    class="w-full sm:max-w-xs px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-right"
                    placeholder="0 - 100">
            </div>
            <!-- Password Field -->
            <div class="mb-6">
                <label for="persentase_UAS"
                    class="text-sm font-medium text-gray-700 flex-shrink-0 w-full sm:w-auto">Persentase
                    UAS</label>
                <input type="number" id="persentase_UAS" name="persentase_UAS" placeholder="40" required
                    class="w-full sm:max-w-xs px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-right"
                    placeholder="0 - 100">
            </div>
