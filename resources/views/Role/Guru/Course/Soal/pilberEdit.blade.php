...
@section('content')
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
        <div class="flex items-start space-x-3">
            ...
            <div>
                <h4 class="text-sm font-semibold text-blue-800 mb-1">Tips Penambahan Soal Pilihan Berganda</h4>
                <ul class="text-xs text-blue-700 space-y-1">
                    <li>• Masukkan Pertanyaan Soal</li>
                    <li>• Masukkan Pilihan Jawaban (A, B, C, D, dll.)</li>
                    <li>• Tentukan Jawaban yang Benar</li>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md h-full w-full">
        ...
        <form action="{{ route('Guru.Soal.update', $soal->id_soal) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="border p-2 mb-4">
                ...
                <textarea id="jawaban-2-textarea" name="jawaban_2" placeholder="Jawaban 2" class="w-full border p-2" rows="2">{{ $jawaban[1]->jawaban ?? '' }}</textarea>
                @error('jawaban_2')
                    <span class="alert-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="border p-2 mb-4">
                <div class="flex space-x-2 mb-2">
                    <button type="button" class="border p-1" id="list-button-3"><i class="fas fa-list"></i></button>
                    <button type="button" class="border p-1" id="bold-button-3"><i class="fas fa-bold"></i></button>
                </div>
                <textarea id="jawaban-3-textarea" name="jawaban_3" placeholder="Jawaban 3" class="w-full border p-2" rows="2">{{ $jawaban[2]->jawaban ?? '' }}</textarea>
                @error('jawaban_3')
                    <span class="alert-danger">{{ $message }}</span>
                @enderror
            </div>
