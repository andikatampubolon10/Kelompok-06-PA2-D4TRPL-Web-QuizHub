...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            {{-- Bagian atas halaman, sesuaikan dengan tempat Anda meletakkan tombol --}}
            <div class="flex items-center justify-end mb-4 gap-3">
                <!-- Button: Tambah Soal (tetap jalan seperti semula) -->
            ...
            <div id="tipeSoalModal"
                ...
                <!-- Tambahkan container dengan padding luar untuk jarak dari tepi layar -->
            ...
            <script>
                ...
                function pilihSoal(tipe) {
                    // Tampilkan konfirmasi pilihan dulu (opsional)
                    Swal.fire({
                        ...
                        // Build URL tujuan create soal sesuai tipe
                        ...
                        // Redirect ke halaman create sesuai tipe
