                    ...
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex space-x-5 justify-end items-center mt-1">
                            ...
                            <a href="{{ route('Guru.Ujian.selesai', ['id_ujian' => $exam->id_ujian]) }}"
                                ...
                                <i class="fas fa-check-circle mr-1"></i> Lihat Siswa Selesai
                            </a>
                            ...
                            <form action="{{ route('Guru.Ujian.edit', $exam->id_ujian) }}" method="GET" class="inline-block">
                                ...
                                <button type="submit"
                                    class="text-blue-500 flex items-center hover:text-blue-700 transition-colors">
                                    <i class="fas fa-edit mr-1"></i> Edit
                                </button>
                            </form>
                            ...
                            <form action="{{ route('Guru.Ujian.destroy', $exam->id_ujian) }}" method="POST"
                                ...
                                @method('DELETE')
                                <button type="submit"
                                    class="text-red-500 flex items-center hover:text-red-700 transition-colors">
